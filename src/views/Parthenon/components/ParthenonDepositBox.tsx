...
import useProfDistStake from '../../../hooks/parthenon/useProfDistStake';
...
const ParthenonDepositBox: React.FC<ParthenonStatusBoxProps> = ({
  stakedAmount,
...
export default ParthenonDepositBox;
