        ...
        <CardContent>
          <StyledCardContentInner>
            ...
            <RabbitRow>
              <RabbitBox>
                <CardImageFirst>
                  <img src="/images/lottery-girl.png" alt="Number 1" width={150} height={190} />
                </CardImageFirst>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1em' }}>
                  <img src="/images/lottery-girl.png" alt="Number 2" width={150} height={190} />
                </CardImage>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1em' }}>
                  <img src="/images/lottery-girl.png" alt="Number 3" width={150} height={190} />
                </CardImage>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1em' }}>
                  <img src="/images/lottery-girl.png" alt="Number 4" width={150} height={190} />
                </CardImage>
              </RabbitBox>
            </RabbitRow>
            {/* <RabbitRowSmall>
