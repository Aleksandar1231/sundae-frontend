...
import useFreezerTotaLProfitDistributionStat from "../../../hooks/Freezer/useFreezerTotaLProfitDistributionStat";
import Spacer from "../../../components/Spacer";
import CountUp from "react-countup";


interface FreezerTotalRewardsProps {
    activeDistributions: ProfitDistributionInfo[];
}
const FreezerTotalRewards: React.FC<FreezerTotalRewardsProps> = ({  activeDistributions }) => {
    const { account } = useWallet();


    const [isDataLoaded, setDataLoaded] = useState(false); //Disable buttons while data loading
    const totalRewardsData = useFreezerTotaLProfitDistributionStat(activeDistributions, !isDataLoaded)
...
export default FreezerTotalRewards;
