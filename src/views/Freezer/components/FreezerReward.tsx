...
const FreezerReward: React.FC<FreezerRewardProps> = ({contractName, price, rewards}) => {
                ...
                <Box justifyContent={'center'} alignContent={'center'} flexDirection={'row'}>
                    <Box display="flex" flexDirection="column" alignItems="center">
                        <Tooltip PopperProps={{disablePortal: true}} placement="bottom" title={contractName}
                            ...
                            <Button
                                onClick={() => {
                                    tombFinance.watchAssetInMetamask(contractName).then();
                                }}
                                color="secondary"
                                variant="text"
                            >
