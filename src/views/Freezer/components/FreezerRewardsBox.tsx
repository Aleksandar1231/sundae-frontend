...
import FreezerReward from './FreezerReward';
...
interface FreezerRewardsBoxProps {
  rewards: number[];
...
const FreezerRewardsBox: React.FC<FreezerRewardsBoxProps> = ({
  rewards = [],
...
export default FreezerRewardsBox;
